    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary">
                ...
                <form class="form-horizontal" method="POST" action="/manage/discounts/add_discount">
                    {{ csrf_field() }}
                    @if (count($errors) > 0)
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="min_price" name="min_price"
                                           value="{{ old('min_price') }}" placeholder="Enter min value" >
                                </div>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="max_price" name="max_price"
                                               value="{{ old('max_price') }}" placeholder="Enter min value">
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
